...
def plot_event(event):
    ...
    for i, metric in enumerate(metrics):
        ...
        axs.set_title('Learning curve {}'.format(metric), fontsize=25)
        axs.set_xlabel('Epoch', fontsize=20)
        axs.set_ylabel(metric, fontsize=20)
        axs.grid(True)
